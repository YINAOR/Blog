							...
							for (a = n[c]; a <= n[f]; a++)
								if (h[a] > l / 2) {
									for (
										e = n.copy(),
											i = n.copy(),
											u = (r = a - n[c]) <= (o = n[f] - a) ? Math.min(n[f] - 1, ~~(a + o / 2)) : Math.max(n[c], ~~(a - 1 - r / 2));
										!h[u];
					...
					avg: function (t) {
						...
						if (!n._avg || t) {
							...
							for (u = n.r1; u <= n.r2; u++)
								for (a = n.g1; a <= n.g2; a++)
									for (c = n.b1; c <= n.b2; c++)
										(f += i = o[e(u, a, c)] || 0), (l += i * (u + 0.5) * s), (h += i * (a + 0.5) * s), (v += i * (c + 0.5) * s)
							n._avg = f
								? [~~(l / f), ~~(h / f), ~~(v / f)]
								: [~~((s * (n.r1 + n.r2 + 1)) / 2), ~~((s * (n.g1 + n.g2 + 1)) / 2), ~~((s * (n.b1 + n.b2 + 1)) / 2)]
						}
						return n._avg
					},
					contains: function (t) {
				...
				(a.prototype = {
					...
					nearest: function (t) {
						for (var r, n, o, e = this.vboxes, i = 0; i < e.size(); i++)
							((n = Math.sqrt(
								Math.pow(t[0] - e.peek(i).color[0], 2) + Math.pow(t[1] - e.peek(i).color[1], 2) + Math.pow(t[2] - e.peek(i).color[2], 2)
							)) < r ||
								void 0 === r) &&
				...
				a = (function (t, r, n) {
					for (var o, e, i, u, a, c = t, f = [], s = 0; s < r; s += n)
						(e = c[0 + (o = 4 * s)]),
							(i = c[o + 1]),
							(u = c[o + 2]),
							(void 0 === (a = c[o + 3]) || a >= 125) && ((e > 250 && i > 250 && u > 250) || f.push([e, i, u]))
					return f
